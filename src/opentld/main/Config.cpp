...
int Config::init(int argc, char **argv)
{
    ...
    if(!m_configPath.empty())
    {
		...
		// pegs and ring
		m_cfg.lookupValue("initializePeg", m_settings.m_initializePeg);
		m_cfg.lookupValue("initializeRing", m_settings.m_initializeRing);
...
int Config::configure(Main *main)
{
	...
	main->initializeRing = m_settings.m_initializeRing;
	main->initializePeg = m_settings.m_initializePeg;
